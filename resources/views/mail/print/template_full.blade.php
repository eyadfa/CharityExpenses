...
<div class="book">
    ...
    <div class="page">
        ...
        <div style="height: 10mm; width: 100%;">
            <h2 style="float: right; ">  السيد /{{$email->receiver->name}}المحترم</h2>
            <table style="float: left;">
                <tr><td> ص:{{ $email->sending_date }}</td></tr>
                <tr><td> {{$email->message_code}}</td></tr>
            </table>
        </div>
        <div style="width: 100%; ">
        ...
        <div style="height: 185mm; width: 100%; text-align: right;">
            {{$email->details}}
        </div>
        ...
        <div style="height: 25mm;">
            <img src="/assets/media/patterns/pattern-1.jpg" class="footer-img" />
        </div>
