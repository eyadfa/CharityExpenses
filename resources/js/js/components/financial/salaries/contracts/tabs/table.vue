    ...
    <div class="card card-xl-stretch mb-5 ">
        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="me-4 btn-group">
                <button :disabled="denies('fin_salaries_contract_search')" class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder dropdown-toggle"  type="button" data-bs-toggle="dropdown" aria-expanded="false" >
                            ...
                            <el-dropdown v-if="scope.row.is_financial_manager_certified == 0 " trigger="click">
                                ...
                                <template #dropdown>
                                    <el-dropdown-menu >
                                        ...
                                        <el-dropdown-item v-if="scope.row.is_certified == 0 && can('fin_salaries_contract_edit')">
                                            <router-link :to="{name: 'editFinancialContractSalaries', params: { id: scope.row.id }}" class="dropdown-item">
                                                تعديل
                                            </router-link>
                                        </el-dropdown-item >

                                        <el-dropdown-item v-if="scope.row.is_certified == 0 && can('fin_salaries_contract_delete')" >
                                            <a  class="dropdown-item" @click.prevent="_delete(scope.row.id)" >
                                                حذف
                                            </a>
                                        </el-dropdown-item>

                                        <el-dropdown-item  v-if="scope.row.is_certified == 0 && can('fin_salaries_contract_certify')" >
                                        ...
                                        <el-dropdown-item >
                                            ...
                                            && can('fin_salaries_contract_manager_certify')" class="dropdown-item" @click.prevent="manager_certify(scope.row.id)" >
...
export default {
    ...
    data() {
        return {
            ...
            add_url: this.$router.resolve({name:'addFinancialContractSalaries'}),
            loading:false,
