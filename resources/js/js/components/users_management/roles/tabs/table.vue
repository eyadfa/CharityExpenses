        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar col-12 d-block">
                ...
                <div class="me-4 btn-group" >
                    <button  :disabled="!can('roles_search')" class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder dropdown-toggle"  type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <el-table-column fixed="right" label="Operations" >
                        <template #default="scope">
                            <div class="btn-group" role="group">
                                <router-link v-show="can('roles_edit')" :to="{name: 'editRole', params: { id: scope.row.id }}"
                                             class="btn btn-primary">
                                    <i class="far fa-edit"></i>
                                </router-link>
                                <button v-show="can('roles_delete')" class="btn btn-danger" @click="_delete(scope.row.id)">
    ...
    export default {
        ...
        data() {
            return {
                title: 'ادارة الأدوار',
                add_title: ' دور  جديد',
                add_url: this.$router.resolve({name: 'addRole'}),
                api_url:"/api/roles",
                results:[],
                form:{}
            }
