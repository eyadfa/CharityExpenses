...
export default {
    ...
    created() {
        ...
        this.search();
        this.results=[
            {date: '2025-08-01', way: 'نقداً', team: 'فريق خانيونس', in: '1500', out: '0', notes: 'دفعة مقدمة مستلمة'},
            {date: '2025-08-02', way: 'تطبيق', team: ' فريق خانيونس', in: '0', out: '750', notes: 'إيجار المكتب'},
            {date: '2025-08-03', way: 'تطبيق', team: 'فريق خانيونس', in: '0', out: '320', notes: 'شراء قرطاسية'},
            {date: '2025-08-04', way: 'نقداً', team: 'فريق خانيونس', in: '2000', out: '0', notes: 'دفعة لمشروع عميل'},
            {date: '2025-08-05', way: 'تطبيق', team: 'فريق خانيونس', in: '0', out: '1200', notes: 'شراء معدات'},
            {date: '2025-08-06', way: 'تطبيق', team: 'فريق خانيونس', in: '0', out: '500', notes: 'مصاريف تسويق'},
            {date: '2025-08-07', way: 'نقداً', team: 'فريق خانيونس', in: '800', out: '0', notes: 'دفعة جزئية مقابل خدمات'}
        ];
        this.total=7;
    },
    methods: {
