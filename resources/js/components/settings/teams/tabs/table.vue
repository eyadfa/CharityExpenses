        ...
        <div class="card-body py-3">
            ...
            <div class="overflow-auto">
                <el-table :data="results" height="500" :stripe="true" style="width: 100%">
                    <el-table-column label="اسم الفريق" prop="name" />
                    <el-table-column label="اسم قائد الفريق" prop="iso" />
                    <el-table-column label="مكان العمل" prop="iso3" />
                    <el-table-column label="المحافظة" prop="nickname" />
...
export default {
    ...
    data() {
        return {
            ...
            add_title: 'فريق جديد',
            add_url: this.$router.resolve({ name: 'addTeam' }),
            form: {},
            results:[],
            api_url:"/api/teams",
            currentPage: 1,
