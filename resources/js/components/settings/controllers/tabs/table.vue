        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar col-12 d-block">
                    <div  class="me-4 btn-group">
                        <button :disabled="!can('controllers_search')"  class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder dropdown-toggle"  type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div class="px-7 py-5">
                                    <div class="row">
                                        ...
                                        <div class="mb-10 col-md-6">
                                            ...
                                            <input type="number" v-model="form.caption" class="form-control form-control-solid"/>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-primary" @click.prevent="search()" data-kt-menu-dismiss="true">بحث</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <el-table :data="results" height="500" :stripe="true" style="width: 100%">
                    ...
                    <el-table-column label=" الحالة" >
                        <template #default="scope">
                            <el-button :disabled="!can('controllers_activation')" v-if="scope.row.is_active ==1" @click.prevent="_deactivate(scope.row.id)" type="success">فعال</el-button>
                            <el-button :disabled="!can('controllers_activation')" v-else @click.prevent="_activate(scope.row.id)" type="danger">غير فعال</el-button>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column fixed="right" label="Operations" >
                        <template #default="scope">
                            <div class="btn-group" role="group">
                                <router-link v-show="can('controllers_edit')" :to="{name: 'editController', params: { id: scope.row.id }}"
