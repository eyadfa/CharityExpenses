    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="row g-5 g-xl-8">
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8" data-bs-toggle="modal" data-bs-target="#kt_modal_departments">
                    <!--begin::Body-->
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5"> اضافة قسم</div>
                    </div>
                    <!--end::Body-->
                </a>
            ...
            <div class="col-xl-3">
                <!--begin::Statistics Widget 5-->
                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_user" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5"> اضافة مستخدم جديد</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
