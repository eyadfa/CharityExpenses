...
class StoreFamFamilyDataRequest extends FormRequest
{
    use HelperTrait;
    /**
    ...
    public function rules()
    {
        return [
            ...
            "family_file_inner_no"=>"required|numeric|unique:fam_families,family_file_inner_no",
            "family_file_outer_no"=>"required|numeric|unique:fam_families,family_file_outer_no",
    ...
    public function attributes()
    {
        return [
            ...
            "sponsorship_end_date"=>"تاريخ نهاية الكفالة",
        ];
    }
}
